...
public class EdgeConvertGUI {
   ...
   static JMenuItem jmiDTOpenEdge, jmiDTOpenSave, jmiDTSave, jmiDTSaveAs, jmiDTExit, jmiDTOptionsOutputLocation, jmiDTOptionsShowProducts, jmiDTHelpAbout,jmiDTHelpAboutProgram,jmiDTHelpExample;
   ...
   public void createDTScreen() {//create Define Tables screen
      ...
      //more menu under about start
      jmiDTHelpAboutProgram = new JMenuItem("About This Program");
      jmiDTHelpAboutProgram.setMnemonic(KeyEvent.VK_A);
      jmiDTHelpAboutProgram.addActionListener(menuListener);
      jmDTHelp.add(jmiDTHelpAboutProgram);
      
      jmiDTHelpExample = new JMenuItem("An Example of How To Use This Program");
      jmiDTHelpExample.setMnemonic(KeyEvent.VK_A);
      jmiDTHelpExample.addActionListener(menuListener);
      jmDTHelp.add(jmiDTHelpExample);
      //more menu under about end
         ...
         new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent lse)  {
               ...
               if (selIndex >= 0) {
                  ...
                  //--------------------Method added, check is all the list been select-----------------
                  if(!jlDRTablesRelations.isSelectionEmpty() && !jlDRTablesRelatedTo.isSelectionEmpty()&& !jlDRFieldsTablesRelations.isSelectionEmpty()&&!jlDRFieldsTablesRelatedTo.isSelectionEmpty())
                  {
   ...
   class CreateDDLButtonListener implements ActionListener {
      public void actionPerformed(ActionEvent ae) {
      check = true;
         while (outputDir == null && check == true) {
   ...
   class EdgeMenuListener implements ActionListener {
      public void actionPerformed(ActionEvent ae) {
         ...
         //Second help screen start
          if ((ae.getSource() == jmiDTHelpExample)) {
            JOptionPane.showMessageDialog(null, "An Example of Read Data from file.\n" +
                                                "1. Click on the File tab\n" +
                                                "2. Click Open Edge File\n" +
                                                "3. Now you should see another window pop up, please click on\n" +
                                                "     Desktop/\n" +
                                                "     milestone3/\n" +
                                                "     milestone3/\n" +
                                                "     Courses.edg\n" +
                                                "     OK\n" +
                                                "4. Now, what we expect to see is\n" +
                                                "     STUDENT\n" +
                                                "     FACULTY\n" +
                                                "     COURSES" );
         }
         //Second help screen end
         
      } // EdgeMenuListener.actionPerformed()
      
      /*
       *The method use to split line if line too long
       *@spl the string of line need to break
       *@line Length to the line break of max
       */
